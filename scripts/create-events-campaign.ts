...
<ul>
  ...
  <li><strong>Σας υποδέχεται άνθρωπος.</strong> Στην είσοδο υπάρχει πάντα προσωπικό
      που κατευθύνει τα οχήματα στις δεσμευμένες θέσεις. Η πινακίδα καταγράφεται
      αυτόματα, χωρίς εισιτήρια.</li>
